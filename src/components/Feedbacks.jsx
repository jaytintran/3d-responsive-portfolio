...
const FeedbackCard = ({
	...
	>
		...
		<div className="mt-1">
			<p className="text-[16px] text-white tracking-wider">{testimonial}</p>
...
const Feedbacks = () => {
	return (
		<div className="mt-12 bg-black-100 rounded-[20px]">
			<div
				className={`${styles.padding} bg-tertiary rounded-2xl min-h-[300ppx]`}
			>
			...
			<div className={`${styles.paddingX} -mt-6 pb-14 flex flex-wrap gap-7`}>
